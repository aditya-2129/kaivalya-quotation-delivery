...
import { X, Tag, Layers, Box, Gauge, IndianRupee } from 'lucide-react';
        ...
        <header className="px-8 py-6 border-b border-zinc-100 bg-zinc-50/50 flex justify-between items-center">
          <div>
            ...
            <p className="text-zinc-500 mt-1 font-medium" style={{ fontSize: THEME.FONT_SIZE.SMALL }}>
              Configure physical properties and market rates for the registry.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          <div className="space-y-1.5">
            <label className="block font-bold text-zinc-400 uppercase tracking-widest" style={{ fontSize: THEME.FONT_SIZE.TINY }}>
              Material Grade / Specification <span className="text-red-500">*</span>
            </label>
            <IconInput icon={Tag}>
              <input required placeholder="e.g. 6061-T6, EN8, SS304" className={inputCls} style={{ fontSize: THEME.FONT_SIZE.BASE }}
          ...
          <div className="space-y-1.5">
            ...
            <IconInput icon={Layers}>
              <input required placeholder="e.g. Aluminium, Alloy Steel" className={inputCls} style={{ fontSize: THEME.FONT_SIZE.BASE }}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <IconInput icon={Gauge}>
                <input required type="number" step="0.001" className={numCls} style={{ fontSize: THEME.FONT_SIZE.BASE }}
                  value={formData.density} onChange={(e) => setFormData({ ...formData, density: e.target.value })} />
              </IconInput>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <label className="block font-bold text-zinc-400 uppercase tracking-widest" style={{ fontSize: THEME.FONT_SIZE.TINY }}>
              Base Rate (₹/kg) <span className="text-red-500">*</span>
            </label>
